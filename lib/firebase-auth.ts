...
export const signUp = async (email: string, password: string, userData: Omit<UserProfile, "uid" | "createdAt">) => {
  ...
  try {
    ...
    console.log("[v0] Firestore access failed during signup, returning temporary profile:", firestoreError.message)
...
export const signIn = async (email: string, password: string) => {
  try {
    ...
    try {
      ...
      console.log("[v0] Firestore access failed, creating temporary profile:", firestoreError.message)
